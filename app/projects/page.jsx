...
// const Skeleton = () => {
//   return (
//     <div class="relative w-72 space-y-3 overflow-hidden rounded-md bg-red-800 p-3 shadow before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/20 hover:shadow-lg before:animate-[shimmer_1.5s_infinite]">
//       <div class="h-36 w-full rounded-lg bg-neutral-600"></div>
//       <div class="space-y-3">
